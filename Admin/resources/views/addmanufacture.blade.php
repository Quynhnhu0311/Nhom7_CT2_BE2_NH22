...
<div class="content-wrapper">
    ...
    <section class="content">
        <form action="/save-manufacture" method="post" roles="form" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="inputName">Quanlity</label>
            ...
            <div class="row">
                <div class="col-7" style="padding-bottom: 16px;">
                    <input name="submit" type="submit" value="Create new Manufacture"
